    ...
    <div>
      ...
      >
        <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
          <Link href="">
            <a style={{backgroundColor:"transparent", color:"#ECA521", border:"1px solid #ECA521"}} className={styles.advertLink}>Elan yerləşdir</a>
          </Link>
        </div>
        <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
          <Link href="">
            <a style={{backgroundColor:"#ECA521", color:"#fff"}} className={styles.cvLink}>CV yerləşdir</a>
          </Link>
        </div>
      </div>
